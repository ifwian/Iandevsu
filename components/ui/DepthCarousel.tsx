...
/**
 * React Bits' DepthCarousel, adapted to TypeScript + CSS Modules for
 * Next.js. Behaviour (drag, wheel, autoplay, keyboard nav, looping)
 * is unchanged from the original — only typing and class names moved
...
export default function DepthCarousel({
  ...
  // Scale the whole stack to fit the container width.
  useEffect(() => {
    ...
    >
      <div className={styles.stage} ref={stageRef}>
        {data.map((item, i) => (
          ...
          >
            <img className={styles.img} src={item.image} alt={item.alt || ""} draggable={false} />
            <span
